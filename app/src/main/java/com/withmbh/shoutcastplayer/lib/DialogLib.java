package com.withmbh.shoutcastplayer.lib;
...
public class DialogLib {
    ...
    public void showBcncDeleteDialog(Context context, final Handler handler,
                                     final int memberSeq, final int infoSeq) {
        new AlertDialog.Builder(context)
                .setTitle(R.string.bcnc_delete)
                .setMessage(R.string.bcnc_delete_message)
                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
